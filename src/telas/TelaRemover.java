...
public class TelaRemover extends JFrame {
    ...
    public TelaRemover(AtualizacaoListener listener) {
        ...
        JComboBox<Produto> produtoComboBox = new JComboBox<>(controladorEstoque.getProdutosEstoque().toArray(new Produto[0]));
        ...
        botaoRemover.addActionListener(e -> {
            ...
            try {
                controladorEstoque.remover(produto, quantidade);
                JOptionPane.showMessageDialog(null, "Produto removido!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
